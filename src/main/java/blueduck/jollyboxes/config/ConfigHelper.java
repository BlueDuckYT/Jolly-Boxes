...
public class ConfigHelper
{
            ...
            final BiFunction<Builder, Subscriber, T> configBuilder)
    {
        ...
        final org.apache.commons.lang3.tuple.Pair<T, ForgeConfigSpec> entry = new Builder().configure(thisBuilder -> configBuilder.apply(thisBuilder, getSubscriber(subscriptionList)));
    ...
    public static class Subscriber
    {
         ...
         */
        public <T> ConfigObjectListener<T> subscribeObject(Builder builder,
                                                           String name,
                                                           Codec<T> codec,
                                                           T defaultObject)
        {
